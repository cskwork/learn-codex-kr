...
tracker:
  ...
  terminal_states: [Done, Archive, Blocked]
...
server:
  port: 9990            # learn-codex-kr (avoid 9991 olive-clone, 9999 default)
...
tui:
  language: ko               # `en` (default) or `ko`. SYMPHONY_LANG env overrides.
