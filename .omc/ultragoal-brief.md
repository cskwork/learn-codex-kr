# Codex Academy KR — Ultragoal Brief
...
- 배포: Vercel free tier
- 백엔드/멀티플레이/DB/Auth: Supabase (Postgres + Realtime + Auth, free tier)
- 호스팅 도메인: vercel.app 서브도메인으로 시작, 추후 커스텀 도메인 검토
- 분석: Vercel Analytics + Supabase 자체 presence count
